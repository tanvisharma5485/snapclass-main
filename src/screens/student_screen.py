...
def student_dashboad():
   ...
   with c2:
      ...
      if st.button("Logout", type="secondary", key="loginbckbtn"):
...
def student_screen():
    ...
    if show_registration: 
       with st.container(border=True):
          ...
          new_name = st.text_input("Enter your name", placeholder='E.g. Krish Gaur')
          ...
          try:
             audio_data = st.audio_input('Record a short phrase like I am present, My name is Tanvi.')
